...
describe Firewater::Ref do
  ...
  describe '#name' do
    ...
    it "identifies a url name correctly" do
      ref = Firewater::Firebase.new( 'https://firewater-test.firebaseio.com/fred/blee' )
  ...
  describe '#root?' do
    ...
    it "identifies non root correctly" do
      ref = Firewater::Firebase.new( 'https://firewater-test.firebaseio.com/fred' )
